...
from videoanalyst.evaluation.event_benchmark.experiments import ExperimentEVENT
...
class EVENTTester(TesterBase):
    ...
    def __init__(self, *args, **kwargs):
        super(EVENTTester, self).__init__(*args, **kwargs)
    ...
    def test(self, ):
        ...
        for subset in self._hyper_params["subsets"]:
            ...
            dataset_name = "EVENT-Benchmark"  # the name of benchmark toolkit, shown under "repo/logs" directory
            ...
            experiment = ExperimentEVENT(root_dir,
                                          subset=subset,
...
EVENTTester.default_hyper_params = copy.deepcopy(
    EVENTTester.default_hyper_params)
EVENTTester.default_hyper_params.update(EVENTTester.extra_hyper_params)
